...
export class RawgGameResponseDto implements RawgGameResponse {
  ...
  @ApiProperty({ description: 'Original (non-localized) game name' })
  ...
  @ApiProperty({ description: 'Reddit subreddit name' })
  reddit_name: string;

  @ApiProperty({ description: 'Reddit subreddit description' })
